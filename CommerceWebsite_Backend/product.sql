...
DROP SCHEMA IF EXISTS `commerce-website`;

CREATE SCHEMA `commerce-website`;
USE `commerce-website`;

CREATE TABLE IF NOT EXISTS `commerce-website`.`product_category` (
...
CREATE TABLE IF NOT EXISTS `commerce-website`.`product` (
    `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
